...
CONST FI='BUBBLETEA.INP';
      FO='BUBBLETEA.OUT';
var m,n,k:longint;
    X,Y,adj,head,A,D,cha:array[0..1000000] of longint;
    adjc,Z,Hang:array[0..1000000] of int64;
    Free,Cv:array[0..1000000] of boolean;

    F,Dem:array[0..1000000,0..20] of longint;
    Ha:array[0..100000,0..2] of longint;
    C:array[0..1000000,0..20] of int64;
    res,kq:int64;
    log:longint;
procedure doc;
var i,j:longint;
...
begin
      ...
      begin
            ...
            fillchar(Free,sizeof(Free),true);
            try(1,1);
            if res=high(int64) div 2 then writeln(-1) else
            writeln(res);
