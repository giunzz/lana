...
\begin{itemize}
    \item Dòng đầu tiên gồm $1$ số nguyên dương $N$ là số lượng đường tròn $(1 \le N \le 100000)$.
    \item $N$ dòng tiếp theo mỗi dòng chứa $2$ số nguyên $x_i$ và $r_i$ là tâm và bán kính đường tròn $(|x_i| \le 10^9, 1 \le r_i \le 10^9)$.
\end{itemize}

\heading{Kết quả}

In ra $1$ số nguyên dương duy nhất là số lượng vùng.
...
\heading{Subtask}
\begin{itemize}
    \item $60\%$ số test mỗi đường tròn chỉ có tối đa $1$ đường tròn con.
    \item $40\%$ số test còn lại không có điều kiện thêm.
\end{itemize}
