...
bool cpr(const segment &a, const segment &b){
    ...
    else if(a.p1.x == b.p1.x && a.p2.x == b.p2.x && a.p1.y < b.p1.y)
        return (a.p1.x == b.p1.x && a.p2.x == b.p2.x && a.p1.y < b.p1.y);
    else if(a.p1.x == b.p1.x && a.p2.x == b.p2.x && a.p1.y == b.p1.y && a.p2.y <= b.p2.y)
        return (a.p1.x == b.p1.x && a.p2.x == b.p2.x && a.p1.y == b.p1.y && a.p2.y <= b.p2.y);
    return 0;
}
...
int main(){
    ...
    lp(i, 1, n){
        ...
        // if(i == 4) cerr << sg.p1.x << " " << sg.p1.y << " " << sg.p2.x  << " " << sg.p2.y;
        getabc(sg);
        gopSeg(sg);
    }
    // ll test = 0;
